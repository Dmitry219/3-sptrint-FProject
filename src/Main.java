...
//        System.out.println("\n" + taskManager.getAllTasks() + "\n");
        ...
        historyManager.add(taskManager.getSubtaskById(subtask1.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask2.getId());
        historyManager.add(taskManager.getSubtaskById(subtask2.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask3.getId());
        historyManager.add(taskManager.getSubtaskById(subtask3.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask4.getId());
        historyManager.add(taskManager.getSubtaskById(subtask4.getId()));
        System.out.println(historyManager.getHistory() + "\n");
        ...
        historyManager.add(taskManager.getEpicById(epic2.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask6.getId());
        historyManager.add(taskManager.getSubtaskById(subtask6.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask7.getId());
        historyManager.add(taskManager.getSubtaskById(subtask7.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask8.getId());
        historyManager.add(taskManager.getSubtaskById(subtask8.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask9.getId());
        historyManager.add(taskManager.getSubtaskById(subtask9.getId()));
        System.out.println(historyManager.getHistory() + "\n");

        taskManager.getSubtaskById(subtask10.getId());
        historyManager.add(taskManager.getSubtaskById(subtask10.getId()));
        System.out.println(historyManager.getHistory() + "\n");
